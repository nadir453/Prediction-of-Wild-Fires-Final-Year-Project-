...
def Load_Dataset():
    ...
    lb_cnt_datset = tkinter.Label(root,text="Total Count of Rows:")
...
def Decision_Tree():
    ...
    Txt_accur.insert(INSERT,"%.2f" % round( acurcy_score,2)          )
    Txt_accur.tag_add("start", "1.0", END)
    Txt_accur.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_abs_error.insert(INSERT,"%.1f" % round(mean_absolute_error(y_test,y_predict ),2)          )
    Txt_abs_error.tag_add("start", "1.0", END)
    Txt_abs_error.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_mean_sqre.insert(INSERT,"%.1f" % mean_squared_error(y_test,y_predict)          )
    ...
    Txt_f1_score.insert(INSERT,round(f1_score(y_test, y_predict,average='weighted') ,2        ))
    Txt_f1_score.tag_add("start", "1.0", END)
    Txt_f1_score.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_recall_score.insert(INSERT,round(recall_score(y_test, y_predict,average='weighted'),2       ))
    Txt_recall_score.tag_add("start", "1.0", END)
    Txt_recall_score.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_precson_score.insert(INSERT,round(precision_score(y_test, y_predict,average='weighted'),2      ))
    ...
    lb_NE_hedng =   tkinter.Label(Decs,text="North East Region:",font=("Georgia", "12", "bold"), fg = "black")
    lb_NE_hedng.place(x=170,y=250)

    
    lb_We_hedng =   tkinter.Label(Decs,text="West:",font=("Georgia", "12", "bold"), fg = "black")
    lb_We_hedng.place(x=440,y=250)

    lb_SU_hedng =   tkinter.Label(Decs,text="South:",font=("Georgia", "12", "bold"), fg = "black")
    lb_SU_hedng.place(x=700,y=250)

    lb_ME_hedng =   tkinter.Label(Decs,text="MidWest:",font=("Georgia", "12", "bold"), fg = "black")
    lb_ME_hedng.place(x=930,y=250)

    

    lb_NE_TP =   tkinter.Label(Decs,text="TP")
    lb_NE_TP.place(x=200,y=280)

    Txt_NE_TP  =   Text(Decs)
    Txt_NE_TP.place(x=150,y=300,width=100,height=50)
    ...
    lb_NE_FP =   tkinter.Label(Decs,text="FP")
    lb_NE_FP.place(x=290,y=280)

    Txt_NE_FP  =   Text(Decs)
    Txt_NE_FP.place(x=250,y=300,width=100,height=50)
    ...
    Txt_NE_FN  =   Text(Decs)
    Txt_NE_FN.place(x=150,y=350,width=100,height=50)

    Txt_NE_FN .insert(INSERT,       confusionMatrix[0, 2] )
    Txt_NE_FN .tag_add("start", "1.0", END)
    Txt_NE_FN.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_NE_TN  =   Text(Decs)
    Txt_NE_TN.place(x=250,y=350,width=100,height=50)

    Txt_NE_TN .insert(INSERT,       confusionMatrix[0, 3] )
    Txt_NE_TN .tag_add("start", "1.0", END)
    Txt_NE_TN.tag_config("start", font=("Georgia", "12", "bold"))
    
    lb_NE_FN =   tkinter.Label(Decs,text="FN")
    lb_NE_FN.place(x=150,y=380)
   
    lb_NE_TN =   tkinter.Label(Decs,text="TN")
    lb_NE_TN.place(x=250,y=380)

    lb_WE_TP =   tkinter.Label(Decs,text="TP")
    lb_WE_TP.place(x=430,y=280)

    Txt_WE_TP  =   Text(Decs)
    Txt_WE_TP.place(x=400,y=300,width=100,height=50)

    lb_WE_FP =   tkinter.Label(Decs,text="FP")
    lb_WE_FP.place(x=550,y=280)

    Txt_WE_FP  =   Text(Decs)
    Txt_WE_FP.place(x=480,y=300,width=100,height=50)

    Txt_WE_FN  =   Text(Decs)
    Txt_WE_FN.place(x=400,y=350,width=100,height=50)


    lb_WE_FN =   tkinter.Label(Decs,text="FN")
    lb_WE_FN.place(x=400,y=380)

    Txt_WE_TN  =   Text(Decs)
    Txt_WE_TN.place(x=480,y=350,width=100,height=50)

    lb_WE_TN =   tkinter.Label(Decs,text="TN")
    lb_WE_TN.place(x=560,y=385)

    Txt_WE_TP .insert(INSERT,       confusionMatrix[1, 0] )
    Txt_WE_TP .tag_add("start", "1.0", END)
    Txt_WE_TP.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_WE_FP .insert(INSERT,       confusionMatrix[1, 1] )
    Txt_WE_FP .tag_add("start", "1.0", END)
    Txt_WE_FP.tag_config("start", font=("Georgia", "12", "bold"))


    Txt_WE_FN .insert(INSERT,       confusionMatrix[1, 2] )
    Txt_WE_FN .tag_add("start", "1.0", END)
    Txt_WE_FN.tag_config("start", font=("Georgia", "12", "bold"))



    Txt_WE_TN .insert(INSERT,       confusionMatrix[1, 3] )
    Txt_WE_TN .tag_add("start", "1.0", END)
    Txt_WE_TN.tag_config("start", font=("Georgia", "12", "bold"))

    lb_SU_TP =   tkinter.Label(Decs,text="TP")
    lb_SU_TP.place(x=680,y=280)

    lb_SU_FP =   tkinter.Label(Decs,text="FP")
    lb_SU_FP.place(x=780,y=280)

    Txt_SU_TP  =   Text(Decs)
    Txt_SU_TP.place(x=650,y=300,width=100,height=50)

    Txt_SU_FP  =   Text(Decs)
    Txt_SU_FP.place(x=740,y=300,width=100,height=50)

   

    Txt_SU_FN  =   Text(Decs)
    Txt_SU_FN.place(x=650,y=350,width=100,height=50)

    lb_SU_FN =   tkinter.Label(Decs,text="FN")
    lb_SU_FN.place(x=650,y=380)

    Txt_SU_TN  =   Text(Decs)
    Txt_SU_TN.place(x=740,y=350,width=100,height=50)

    lb_SU_TN =   tkinter.Label(Decs,text="TN")
    lb_SU_TN.place(x=820,y=380)

    Txt_SU_TP .insert(INSERT,       confusionMatrix[2, 0] )
    Txt_SU_TP .tag_add("start", "1.0", END)
    Txt_SU_TP.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_SU_FP .insert(INSERT,       confusionMatrix[2, 1] )
    Txt_SU_FP .tag_add("start", "1.0", END)
    Txt_SU_FP.tag_config("start", font=("Georgia", "12", "bold"))


    Txt_SU_FN .insert(INSERT,       confusionMatrix[2, 2] )
    Txt_SU_FN .tag_add("start", "1.0", END)
    Txt_SU_FN.tag_config("start", font=("Georgia", "12", "bold"))



    Txt_SU_TN .insert(INSERT,       confusionMatrix[2, 3] )
    Txt_SU_TN .tag_add("start", "1.0", END)
    Txt_SU_TN.tag_config("start", font=("Georgia", "12", "bold"))

    lb_MW_TP =   tkinter.Label(Decs,text="TP")
    lb_MW_TP.place(x=890,y=280)

    lb_MW_FP =   tkinter.Label(Decs,text="FP")
    lb_MW_FP.place(x=1000,y=280)

    Txt_MW_TP  =   Text(Decs)
    Txt_MW_TP.place(x=880,y=300,width=100,height=50)

    Txt_MW_FP  =   Text(Decs)
    Txt_MW_FP.place(x=980,y=300,width=100,height=50)


    Txt_MW_FN  =   Text(Decs)
    Txt_MW_FN.place(x=880,y=350,width=100,height=50)

    lb_MW_FN =   tkinter.Label(Decs,text="FN")
    lb_MW_FN.place(x=880,y=380)

    Txt_MW_TN  =   Text(Decs)
    Txt_MW_TN.place(x=980,y=350,width=100,height=50)

    lb_MW_TN =   tkinter.Label(Decs,text="TN")
    lb_MW_TN.place(x=1060,y=380)

    Txt_MW_TP .insert(INSERT,       confusionMatrix[3, 0] )
    Txt_MW_TP .tag_add("start", "1.0", END)
    Txt_MW_TP.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_MW_FP .insert(INSERT,       confusionMatrix[3, 1] )
    Txt_MW_FP .tag_add("start", "1.0", END)
    Txt_MW_FP.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_MW_FN .insert(INSERT,       confusionMatrix[3, 2] )
    Txt_MW_FN .tag_add("start", "1.0", END)
    Txt_MW_FN.tag_config("start", font=("Georgia", "12", "bold"))


    Txt_MW_TN .insert(INSERT,       confusionMatrix[3, 3] )
    Txt_MW_TN .tag_add("start", "1.0", END)
    Txt_MW_TN.tag_config("start", font=("Georgia", "12", "bold"))
    ...
    dotfile = open("D:/DecisionTree.txt", 'w')
    tree.export_graphviz( fit, out_file = dotfile, feature_names = X.columns)
    dotfile.close()
...
def Classification():
    ...
    Txt_accur.insert(INSERT,"%.2f" %  acurcy_score          )
    Txt_accur.tag_add("start", "1.0", END)
    Txt_accur.tag_config("start", font=("Georgia", "12", "bold"))
    ...
    lb_NE_hedng =   tkinter.Label(Cls,text="North East Region:",font=("Georgia", "12", "bold"), fg = "black")
    lb_NE_hedng.place(x=170,y=250)

    
    lb_We_hedng =   tkinter.Label(Cls,text="West:",font=("Georgia", "12", "bold"), fg = "black")
    lb_We_hedng.place(x=440,y=250)

    lb_SU_hedng =   tkinter.Label(Cls,text="South:",font=("Georgia", "12", "bold"), fg = "black")
    lb_SU_hedng.place(x=700,y=250)

    lb_ME_hedng =   tkinter.Label(Cls,text="MidWest:",font=("Georgia", "12", "bold"), fg = "black")
    lb_ME_hedng.place(x=930,y=250)

    

    lb_NE_TP =   tkinter.Label(Cls,text="TP")
    lb_NE_TP.place(x=200,y=280)
    ...
    lb_NE_FP =   tkinter.Label(Cls,text="FP")
    lb_NE_FP.place(x=290,y=280)
    ...
    lb_NE_FN =   tkinter.Label(Cls,text="FN")
    lb_NE_FN.place(x=150,y=380)
   
    lb_NE_TN =   tkinter.Label(Cls,text="TN")
    lb_NE_TN.place(x=250,y=380)

    lb_WE_TP =   tkinter.Label(Cls,text="TP")
    lb_WE_TP.place(x=430,y=280)

    Txt_WE_TP  =   Text(Cls)
    Txt_WE_TP.place(x=400,y=300,width=100,height=50)

    lb_WE_FP =   tkinter.Label(Cls,text="FP")
    lb_WE_FP.place(x=550,y=280)
    ...
    lb_WE_FN =   tkinter.Label(Cls,text="FN")
    lb_WE_FN.place(x=400,y=380)

    Txt_WE_TN  =   Text(Cls)
    Txt_WE_TN.place(x=480,y=350,width=100,height=50)

    lb_WE_TN =   tkinter.Label(Cls,text="TN")
    lb_WE_TN.place(x=560,y=385)
    ...
    lb_SU_TP =   tkinter.Label(Cls,text="TP")
    lb_SU_TP.place(x=680,y=280)

    lb_SU_FP =   tkinter.Label(Cls,text="FP")
    lb_SU_FP.place(x=780,y=280)
    ...
    lb_SU_FN =   tkinter.Label(Cls,text="FN")
    lb_SU_FN.place(x=650,y=380)

    Txt_SU_TN  =   Text(Cls)
    Txt_SU_TN.place(x=740,y=350,width=100,height=50)

    lb_SU_TN =   tkinter.Label(Cls,text="TN")
    lb_SU_TN.place(x=820,y=380)
    ...
    lb_MW_TP =   tkinter.Label(Cls,text="TP")
    lb_MW_TP.place(x=890,y=280)

    lb_MW_FP =   tkinter.Label(Cls,text="FP")
    lb_MW_FP.place(x=1000,y=280)
    ...
    lb_MW_FN =   tkinter.Label(Cls,text="FN")
    lb_MW_FN.place(x=880,y=380)

    Txt_MW_TN  =   Text(Cls)
    Txt_MW_TN.place(x=980,y=350,width=100,height=50)

    lb_MW_TN =   tkinter.Label(Cls,text="TN")
    lb_MW_TN.place(x=1060,y=380)
    ...
    #clasfcton_matrix = np.array([clasfcton_reprt])
    #print("The classification Report generated is:", clasfcton_reprt[0,0])
...
def Model_Comparsion():
    ...
    lb_precson=   tkinter.Label( Mcp,text="Sensitivity" ,font=("Georgia", "14", "bold"), fg = "black")
    lb_precson.place(x=750,y=170)


    Txt_Decs_recall.insert(INSERT,0.92      )
    Txt_Decs_recall.tag_add("start", "1.0", END)
    Txt_Decs_recall.tag_config("start", font=("Georgia", "12", "bold"))

    Txt_Classfiction_recall.insert(INSERT,0.95      )
